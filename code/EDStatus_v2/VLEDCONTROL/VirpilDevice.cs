...
namespace VLEDCONTROL
{
    public class VirpilDevice : Loggable, IDisposable
    {
        ...
        public VirpilDevices DeviceType { get; set; }
        ...
        public VirpilDevice(VirpilDevices device, String vid, String pid, int ledMin, int ledMax)
        {
        ...
        private int _led_min = 0;
        private int _let_max = 0;

        public int LED_MIN { get { return _led_min; } }
        public int LED_MAX { get { return _let_max; } }
        ...
        {
            return string.Format("{0}: {1} {1}", Name, USB_VID, USB_PID);
        }

        public override int GetHashCode()
        {
            return USB_VID.GetHashCode() ^ USB_PID.GetHashCode();
        }
